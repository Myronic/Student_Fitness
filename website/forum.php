...
<div class="container">
       <br>
    	<h4 id="asktag">Type your question here :</h4>
		<form action="insert.php" method="POST">
        <div class="text-center">
            <textarea rows="3" name="qtn" id="txt" style="border-radius:10px" placeholder=""></textarea><br>
        </div>
        <div class="text-left">
            <input type="submit" name="submit" value="ASK QUESTION" class="b btn btn-md" style="background: linear-gradient(135deg,#3F5EFB, #E100FF);color: white;margin-top:5px;margin-bottom:5px">
        </div>
		</form>
</div>
